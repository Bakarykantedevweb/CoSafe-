...
<head>
    ...
    <meta charset="utf-8" />
    <title>Creation de compte | CoSafe | Business Guardians </title>
    ...
    <nav class="bg-indigo-600 header">
        ...
        <div>4️⃣ AGISSEZ POUR UN TERRITOIRE SÉCURISÉ</div>
                ...
                <div class="p-8 rounded-xl shadow-md">
                                            ...
                                            <div class="auth-content bg-indigo-600 card-body p-5 text-white">
                                                <div class="w-100">
                                                    <div class="text-center">
                                                        <h5>Creation de compte Business Guardians </h5>
                                                    </div>
                                                    <form action="{{ url('business/register') }}" class="auth-form" method="POST">
                                                        @csrf
                                                        <div class="mb-3">
