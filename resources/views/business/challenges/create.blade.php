...
=======
                        <form method="POST" action="{{ url('campus/challenges/create') }}" enctype="multipart/form-data">
                            ...
                            <!-- Section 1: Identification du promoteur du challenge -->
                            <div class="alert alert-secondary">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="alert alert-secondary">
                                        <h4 class="text-secondary"><i class="bi bi-person-badge"></i> Informations personnelles du contact</h4>
                                    </div>
                                    <div class="col-md-12 mb-3">
                                        <label class="form-label" for="">Nom & prénom</label>
                                        <input class="form-control" type="text" name="nom">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label" for="">Pays</label>
                                            <select class="form-control form-select mb-3" name="pays" id="pays">
                                                <option value="France">France</option>
                                                <option value="Luxembourg">Luxembourg</option>
                                                <option value="Belgique">Belgique</option>
                                            </select>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select id="ville" name="ville" class="form-control col-sm-12" required>
                                                @foreach ($villes_frances as $v)
                                                    <option data-option="France" value="{{ $v }}">{{ $v }}</option>
                                                @endforeach
                                                @foreach ($villes_luxembourg as $v)
                                                    <option data-option="Luxembourg" value="{{ $v }}">{{ $v }}</option>
                                                @endforeach
                                                @foreach ($villes_belgique as $v)
                                                    <option data-option="Belgique" value="{{ $v }}">{{ $v }}</option>
                                                @endforeach
                                            </select>
                            ...
                            <!-- Section 2: Informations complémentaires (si vous êtes une entreprise) -->
                            <h2 class="fs-title">Informations complémentaires (si vous êtes une entreprise)</h2>
                            <div class="row">
                                <div class="col-lg-6 mb-3">
                                    <input type="text" class="form-control" id="nomcommercial" name="nomcommercial" placeholder="Nom commercial">
                                    @error('nomcommercial') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
                                <div class="col-lg-6 mb-3">
                                    <input type="text" class="form-control" id="numeroentreprise" name="numeroentreprise" placeholder="N° d'entreprise">
                                    @error('numeroentreprise') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
                                <div class="col-lg-6 mb-3">
                                    <input type="text" class="form-control" name="numeroagreation" placeholder="N° d'agréation">
                                    @error('numeroagreation') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
                                <div class="col-lg-6 mb-4">
                                    <select id="typesactivite" name="typesactivite[]" multiple class="form-control form-select typesActiviteSelect2">
                                        <option value="Aides au quotidien">Aides au quotidien</option>
                                        <option value="Aides aux personnes">Aides aux personnes</option>
                                        <option value="Enfants &amp; Soutiens scolaires">Enfants &amp; Soutiens scolaires</option>
                                    ...
                                    @error('typesactivite') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
                                <div class="col-lg-6 mb-3">
                                    <label>Date début d’activité</label>
                                    <input type="date" min="2025-03-18" class="form-control" id="datedebutinscription" name="datedebutinscription" required>
                                    @error('datedebutinscription') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
                                <div class="col-12 col-md-12 mb-3">
                                    <label>Description complémentaire éventuelle :</label>
                            ...
                            <!-- Section 3: Informations du Safe-Challenge -->
                            <div class="alert alert-secondary">
                                <h4 class="text-secondary"><i class="bi bi-info-square"></i> Informations du Safe-Challenge</h4>
                            </div>
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    <label class="form-label" for="">Nom du challenge</label>
                                    <input class="form-control" type="text" name="nomchallenge">
                                    @error('nomchallenge') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
                                <div class="col-md-12 mb-3">
                                    <label for="">Image représentant le challenge</label>
                                ...
                                <div class="col-12 col-md-6 mb-3">
                                    ...
                                    <select class="form-select" name="type">
                                        <option value="Soutenir la jeunesse">Soutenir la jeunesse</option>
                                        <option value="Agir contre la précarité des étudiants.es">Agir contre la précarité des étudiants.es</option>
                                        <option value="Soutenir les seniors">Soutenir les seniors</option>
                                        <option value="Agir pour l'environnement & la planète">Agir pour l'environnement & la planète</option>
                                        <option value="Agir contre la pauvreté">Agir contre la pauvreté</option>
                                        <option value="Agir pour l'égalité sociale et des genres">Agir pour l'égalité sociale et des genres</option>
                                        <option value="Agir pour la prévention sociale">Agir pour la prévention sociale</option>
                                        <option value="Agir contre l'isolement">Agir contre l'isolement</option>
                                        <option value="Agir pour l'économie locale">Agir pour l'économie locale</option>
                                    </select>
                                ...
                                <div class="col-12 col-md-6 mb-3">
                                    ...
                                    <select class="form-select" name="secteurs">
                                        ...
                                        <option value="industrie-extractive">Industrie extractive</option>
                                        <option value="industrie-manufacturiere">Industrie manufacturière</option>
                                        <option value="energie-eau-dechets">Production et distribution d’électricité, gaz, vapeur, air conditionné, eau, assainissement & gestion des déchets</option>
                                        <option value="commerce-reparation">Commerce et réparation de véhicules automobiles et motocycles</option>
                                        <option value="transport">Transport et entreposage</option>
                                        <option value="hebergement-restauration">Hébergement et restauration</option>
                                        <option value="information-communication">Information et communication</option>
                                        <option value="finance-assurance">Activités financières et d’assurance</option>
                                        <option value="immobilier">Activités immobilières</option>
                                        <option value="services-techniques">Activités spécialisées, techniques et scientifiques</option>
                                        <option value="services-administratifs">Activités de services administratives et de soutien</option>
                                        <option value="administration-publique">Administration publique</option>
                                        <option value="enseignement">Enseignement</option>
                                        <option value="sante-action-sociale">Santé humaine et action sociale</option>
                                        <option value="arts-spectacles">Arts, spectacles et activités récréatives</option>
                                    </select>
                                    @error('secteurs') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
                                <div class="col-12 col-md-12 mb-3">
                                    <label>Description du challenge:</label>
                                    <textarea class="form-control" rows="5" name="description"></textarea>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 mb-3">
                                    <label>Date de fin des inscriptions</label>
                                    <input type="date" min="2025-03-18" class="form-control" id="datefininscription" name="datefininscription" required>
                                    @error('datefininscription') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 mb-3">
                                    <label>Date de début des sélections</label>
                                    <input type="date" min="2025-03-18" class="form-control" id="datedebutselection" name="datedebutselection" required>
                                    @error('datedebutselection') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
                                <div class="col-lg-6 mb-3">
                                    <label>Date de fin des sélections</label>
                                    <input type="date" min="2025-03-18" class="form-control" id="datefinselection" name="datefinselection" required>
                                    @error('datefinselection') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12 mb-3">
                                    <label for="typesactivite" class="text-primary">Formes des équipes</label>
                                    <select class="form-control form-select" id="compositionequipes" name="compositionequipes" required>
                                        <option value="" selected>Composition des équipes</option>
                                        <option value="En solo">En solo</option>
                                        <option value="En equipe de 2-5 participants">En equipe de 2-5 participants</option>
                                    </select>
                                ...
                                <div class="col-lg-6 mb-3">
                                    <input type="number" min="1" placeholder="Nombre d'équipes minimum" class="form-control" id="nombreequipesmin" name="nombreequipesmin" required>
                                    @error('nombreequipesmin') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
                                <div class="col-lg-6 mb-3">
                                    <input type="number" min="1" placeholder="Nombre d'équipes maximum" class="form-control" id="nombreequipesmax" name="nombreequipesmax" required>
                                    @error('nombreequipesmax') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
                                <div class="col-lg-12 mb-3">
                                    <label for="typesactivite" class="text-primary">Critère de participation</label>
                                    <select class="form-control form-select" id="criteresparticipation" name="criteresparticipation" required>
                                        <option value="" selected>Sélectionnez un critère</option>
                                        <option value="Être un recruteur ou entreprise">Être un recruteur ou entreprise</option>
                                        <option value="Être une Association ou une localité">Être une Association ou une localité</option>
                                        <option value="Accepter le règlement et les conditions de participation">Accepter le règlement et les conditions de participation</option>
