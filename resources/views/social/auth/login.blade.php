...
<head>
        ...
        <meta charset="utf-8" />
        <title>Connexion | CoSafe | Social Sponsors  </title>
                                                ...
                                                <div class="auth-content card-body p-5 h-100 text-white">
                                                    <div class="w-100">
                                                        <div class="text-center mb-4">
                                                            <h3>Connexion Social Sponsors  </h3>
                                                            <p class="text-white-70">Connectez-vous a votre compte COSAFE.</p>
                                                        </div>
                                                        <form action="{{ url('social/login') }}" class="auth-form" method="POST">
                                                            @csrf
                                                            <div class="mb-3">
                                                        ...
                                                        <div class="mt-4 text-center">
                                                            <p class="mb-0">Vous n'avez pas de compte ? <a href="{{ url('social/register') }}" class="fw-medium text-white text-decoration-underline"> S'inscrire</a></p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div><!--end col-->
