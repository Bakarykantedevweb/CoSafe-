...
<head>
    ...
    <meta charset="utf-8" />
    <title>Creation de compte | CoSafe | Social Sponsors  </title>
                                            ...
                                            <div class="auth-content card-body p-5 text-white">
                                                <div class="w-100">
                                                    <div class="text-center">
                                                        <h5>Creation de compte Social Sponsors  </h5>
                                                    </div>
                                                    <form action="{{ url('social/register') }}" class="auth-form" method="POST">
                                                        @csrf
                                                        <div class="mb-3">
