            ...
            <div class="col-lg-12 col-md-12 col-12">
                <div
                    ...
                    <div class="d-flex gap-3">
                        <a href="{{ url('social/reports') }}" class="btn btn-primary">Retour</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="offset-xl-12 col-xl-12 col-md-12 col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-lg-6">
                            <!-- form -->
                            <form method="POST" action="{{ url('social/reports/create') }}" enctype="multipart/form-data" class="row gx-3 needs-validation">
                                @csrf
                                @method('POST')
                                <!-- form group -->
