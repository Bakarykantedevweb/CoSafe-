                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-lg"
                                    ...
                                    <div>
                                                        ...
                                                        <a class="text-body" href="#">
                                                            <div class="d-flex">
                                                                ...
                                                                <div class="ms-3">
                                                                    ...
                                                                    <p class="mb-3">Un nouveau signalement a été
                                                                        effectué près de votre campus</p>
                                                                    <span class="fs-6">
                                                                        <span>
                                                                            <span
                                                                                class="fe fe-flag text-success me-1"></span>
                                                                            Il y a 2 heures,
                                                                        </span>
                                        ...
                                        <div class="border-top px-3 pt-3 pb-0">
                                            <a href="#" class="text-link fw-semibold">Voir toutes les
                                                notifications</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownUser">
                                    <div class="dropdown-item">
                                        <div class="d-flex">
                                            ...
                                            <div class="ms-3 lh-1">
                                                <h5 class="mb-1">
                                                    {{ Auth::guard('campus')->user()->name ?? 'Utilisateur' }}</h5>
                                                <p class="mb-0">
                                                    {{ Auth::guard('campus')->user()->email ?? 'utilisateur@campus.fr' }}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <ul class="list-unstyled">
                                        <li>
                                            <a class="dropdown-item" href="{{ url('campus/logout') }}"
                                                onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                                <i class="fe fe-power me-2"></i>
                                                Déconnexion
                                            </a>
                                            <form id="logout-form" action="{{ url('campus/logout') }}"
                            ...
                            <div class="d-flex gap-3">
                                <div class="input-group">
                                    <input class="form-control flatpickr" type="text"
                                        placeholder="Sélectionner une date" aria-describedby="basic-addon2" />
