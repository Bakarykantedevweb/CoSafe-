            ...
            <div class="col-lg-12 col-md-12 col-12">
                <div
                    ...
                    <div class="d-flex gap-3">
                        <a href="{{ url('territory/challenges/create') }}" class="btn btn-primary">Ajouter</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="fs-4 fw-normal w-100 border border-primary rounded-1 py-2 px-4 mb-4">
                            ...
                            <div>
                                <p class="mb-2">
                                    1- Valorisez votre employabilité et affinez votre social branding en publiant un post
                                    percutant sur les réseaux sociaux, en direction de votre communauté ou de recruteurs de
                                    notre communauté
                                </p>
                                <p class="mb-2">
                                    2- Publiez votre propre Safe-Challenge pour impacter positivement la sécurité de notre
                        ...
                        <div class="d-flex align-items-center justify-content-around">
                            ...
                            <a class="btn btn-primary btn-lg" href="/territory/challenges/posterintrodchallenge">
                                        ...
                                        <span class="dropdown dropstart">
                                            ...
                                            <span class="dropdown-menu" aria-labelledby="courseDropdown2">
                                                ...
                                                <a class="dropdown-item"
                                                    href="{{ url('territory/challenges/descriptionchallenge/' . $challenge->id) }}">
                                                    <i class="fe fe-edit dropdown-item-icon"></i>
                                                    Edit
                                                </a>
                                                <a class="dropdown-item" href="#">
                                    ...
                                    <tbody>
                                        @foreach ($challenges as $challenge)
                                            <tr>
                                                <td>{{ $challenge->id }}</td>
                                                <td>
                                                    <img src="{{ asset($challenge->image) }}" width="100" alt="pas d'image">
                                                </td>
                                                <td>{{ $challenge->nomchallenge }}</td>
                                                <td>France</td>
                                                <td>{{ $challenge->type }}</td>
                                                <td>{{ $challenge->secteurs }}</td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
