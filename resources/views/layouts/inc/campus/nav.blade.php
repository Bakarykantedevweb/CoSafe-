<nav class="navbar-vertical navbar">
    <div class="vh-100" data-simplebar>
        ...
        <ul class="navbar-nav flex-column" id="sideNavbar">
            <li class="nav-item">
                <a class="nav-link " href="{{ url('/campus/dashboard') }}">
            ...
            <li class="nav-item">
                <a class="nav-link  collapsed " href="{{ url('campus/reports') }}">
            ...
            <li class="nav-item">
                <a class="nav-link  collapsed " href="{{ url('campus/challenges/helps') }}">
                    <i class="nav-icon fe fe-flag me-2"></i>
                    Un Safe-Challenge, c'est quoi ?
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link  collapsed " href="{{ url(path: 'campus/challenges/trouverchallenge') }}">
                    <i class="nav-icon fe fe-flag me-2"></i>
