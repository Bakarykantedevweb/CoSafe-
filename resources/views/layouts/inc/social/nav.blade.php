<nav class="navbar-vertical navbar">
    <div class="vh-100" data-simplebar>
        <!-- Brand logo -->
        <a class="navbar-brand" href="{{ url('social/dashboard') }}">
        ...
        <ul class="navbar-nav flex-column" id="sideNavbar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ url('social/reports') }}">
            ...
            <li class="nav-item club-challenge">
                <a class="nav-link" href="{{ url('social/challenges/trouverchallenge') }}">
                    <i class="nav-icon fe fe-search me-2"></i>
                    1-Trouver un challenge
                </a>
            </li>
            <li class="nav-item club-challenge">
                <a class="nav-link" href="{{ url('social/challenges') }}">
                    <i class="nav-icon fe fe-list me-2"></i>
                    2- Mes Challenges
                </a>
            </li>
            <li class="nav-item club-challenge">
                <a class="nav-link" href="{{ url('social/challenges/helps') }}">
                    <i class="nav-icon fe fe-help-circle me-2"></i>
            ...
            <!-- Déconnexion -->
            <li class="nav-item">
                <a class="nav-link" href="{{ url('social/logout') }}"
                    onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                    <i class="nav-icon fe fe-power me-2"></i>
                    Déconnexion
                </a>
                <form id="logout-form" action="{{ url('social/logout') }}" method="POST" class="d-none">
                    @csrf
                </form>
            </li>
        </ul>
