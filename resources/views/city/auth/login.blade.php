...
<head>
        ...
        <meta charset="utf-8" />
        <title>Connexion | CoSafe | City Angel</title>
                                ...
                                <div class="col-xl-10 col-lg-12">
                                    <div class="card bg-indigo-600">
                                        <div class="row g-0">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="auth-content bg-indigo-600 card-body p-5 h-100 text-white">
                                                    <div class="w-100">
                                                        <div class="text-center mb-4">
                                                            <h3>Connexion City Angels</h3>
                                                            <p class="text-white-70">Connectez-vous a votre compte COSAFE.</p>
                                                        </div>
                                                        <form action="{{ url('city/login') }}" class="auth-form" method="POST">
                                                            @csrf
                                                            <div class="mb-3">
                                                        ...
                                                        <div class="mt-4 text-center">
                                                            <p class="mb-0">Vous n'avez pas de compte ? <a href="{{ url('city/register') }}" class="fw-medium text-white text-decoration-underline"> S'inscrire</a></p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div><!--end col-->
