...
<div class="container card mt-4">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="vigilance1">Mise en place d’une veille citoyenne</label>
                        </div>
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="vigilance2">
                            <label class="form-check-label" for="vigilance2">Signalement d’une zone à risque</label>
                        </div>
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="vigilance3">
                            <label class="form-check-label" for="vigilance3">Demande de sécurisation d’un lieu</label>
                        </div>
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="vigilance4">
                            <label class="form-check-label" for="vigilance4">Organisation de patrouilles citoyennes</label>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="geolocalisation" placeholder="Adresse ou zone approximative" required>
            </div>
    ...
    <div class="col-md-3 form-check">
        <input class="form-check-input" type="radio" name="budget" id="pas_de_budget" value="pas_de_budget">
    ...
    <div class="col-md-3 form-check">
        <input class="form-check-input" type="radio" name="budget" id="service_social" value="service_social">
        <label class="form-check-label" for="service_social">Je fais appel à un service social</label>
            ...
            <div class="mb-3">
                ...
                <div class="col-md-4 form-check">
                    <input class="form-check-input" type="checkbox" name="destinataires[]" value="city Angel"> city Angel
                </div>
                <div class=" col-md-4 form-check">
