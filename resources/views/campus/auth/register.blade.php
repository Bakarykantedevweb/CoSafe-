...
<head>
    ...
    <meta charset="utf-8" />
    <title>Creation de compte | CoSafe | Campus Angel</title>
                                            ...
                                            <div class="auth-content card-body p-5 text-white">
                                                <div class="w-100">
                                                    <div class="text-center">
                                                        <h5>Creation de compte Campus Angel</h5>
                                                    </div>
                                                    <form action="{{ url('campus/register') }}" class="auth-form" method="POST">
                                                        @csrf
                                                        <div class="mb-3">
